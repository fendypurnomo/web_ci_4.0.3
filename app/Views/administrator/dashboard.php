...
<head>
	...
	<link rel="stylesheet" href="http://localhost/libs/dropify/dist/css/dropify.min.css">
	...
	<link rel="stylesheet" href="http://localhost/libs/dataTables/1.10.21/css/dataTables.bootstrap4.min.css">
...
<body>
	...
	<?= view('administrator/_partials/navbar') ?>
	<div class="wrapper d-flex flex-row">
		<?= view('administrator/_partials/sidebar') ?>
		<main class="d-flex flex-column overflow-y-auto-custom">
			<div class="content flex-grow-1">
				<ng-view></ng-view>
			</div>
			<?= view('administrator/_partials/footer') ?>
		</main>
	</div>
	...
	<script type="text/javascript" src="http://localhost/libs/dataTables/1.10.21/js/jquery.dataTables.min.js"></script>
	<script type="text/javascript" src="http://localhost/libs/dataTables/1.10.21/js/dataTables.bootstrap4.min.js"></script>
	...
	<script type="text/javascript" src="<?= base_url('assets/js/ngApp/ngAppRoutesDashboard.js') ?>"></script>
	...
	<script type="text/javascript" src="<?= base_url('assets/js/ngApp/administrator.controller.js') ?>"></script>
</body>
